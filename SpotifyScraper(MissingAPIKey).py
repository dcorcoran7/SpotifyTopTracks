...
# Obtain clientID and clientSecret from Spotify for Developers, then change userID ato your spoify username
# and redirect_uri to your redirect page for access authorization
clientID = "-------------------"
clientSecret = "------------------"
...
# Get an access token
token_info = sp_oauth.get_access_token() # If access token already exists, write token_info = sp.oauth.get_access_token(), if not then token_info = sp_oauth.get_cached_token()
